        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 max-w-md w-full shadow-xl">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-xl font-bold text-black">{dialogTitle}</h3>
              <button
              ...
              {currentFormats && currentFormats.map((format, index) => (
                ...
                >
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-gray-900">{format.name}</span>
                  </div>
                  <ExternalLink size={16} className="text-gray-400 hover:text-black transition-colors duration-200" />
                </a>
              ))}
            </div>
